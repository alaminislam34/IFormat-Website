        ...
        <div className="grid md:grid-cols-12 gap-12 mb-16">
          <div className="md:col-span-6">
            ...
            <div className="flex gap-4">
              ...
              <a href="#" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-brand-cyan transition-colors">
              ...
              <a href="#" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-[#ec4899] transition-colors">
          ...
          <div className="md:col-span-3">
            ...
            <ul className="space-y-4 text-slate-400 text-sm">
              <li><Link href="/job-portal" className="hover:text-white transition-colors">Job Portal</Link></li>
              <li><Link href="/job-assistant" className="hover:text-white transition-colors">AI Career Assistant</Link></li>
              <li><Link href="/services" className="hover:text-white transition-colors">Consultations & Strategy</Link></li>
              <li><Link href="/#pricing" className="hover:text-white transition-colors">Products & Pricing</Link></li>
            </ul>
          </div>
